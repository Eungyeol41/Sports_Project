...
<body>
	...
	<table class="search">
		...
		<tr class="search">
			...
			<td>
				<input id="ch" type="checkbox" name="addr1" value="동구" /> 동구 
				<input id="ch" type="checkbox" name="addr2" value="서구" /> 서구 
				<input id="ch" type="checkbox" name="addr3" value="남구" /> 남구 
				<input id="ch" type="checkbox" name="addr4" value="북구" /> 북구 
				<input id="ch" type="checkbox" name="addr5" value="광산구" /> 광산구 
