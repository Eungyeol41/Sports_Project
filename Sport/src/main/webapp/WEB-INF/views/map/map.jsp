...
<body>
    ...
    <div id="menu_wrap" class="bg_white">
        <div class="option">
            <div>
            	...
            	<button onsubmit="searchPlaces(); return false;" type="submit">검색하기</button> 
            </div>
        </div>
	        <hr>
	        <ul id="placesList"></ul>
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=91a23ccb23ee3ce44c2a7f3683901012||braries=services"></script>
	<script>
		// 마커를 담을 배열입니다
		var markers = [];
